...
export default function HowItWorksCard({
  ...
  const BaseContent = (
    <div className="flex flex-col items-center justify-center transition desktop1:items-start font-mainFont desktop1:hover:scale-110 h-auto">
      <div className="bg-buttonColorPink mb-[32px] p-[25px] flex justify-center items-center rounded-full h-[48px] w-[48px] text-white text-title1 font-semibold">
        {number}
      </div>
  ...
  const StaticContent = (
    <div className="flex flex-col items-center justify-center tablet1:w-[45%] transition desktop1:items-start font-mainFont desktop1:hover:scale-110 h-auto">
      ...
      <h1 className="text-[20px] font-secondFont font-bold mb-[24px]">
        {title}
      </h1>
      <p className="text-[16px] font-secondFont opacity-70 text-center desktop1:text-left w-full">
        {description}
      </p>
    </div>
  );
